    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-jet-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')" placeholder="Name" required />
            </div>

            <div class="mt-4">
                <!-- <x-jet-label for="last_name" value="{{ __('Last Name') }}" /> -->
                <x-jet-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" :value="old('last_name')" placeholder="Last name" required autofocus autocomplete="name" />
            </div>
